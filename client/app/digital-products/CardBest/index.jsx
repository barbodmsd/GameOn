...
export default function index({title,brand,price,image,id}) {
  return (
    <div className="w-[100%] mt-4">
      <div className="card-best  flex items-center justify-between  hover:text-black w-[100%]  rounded-l-xl hover:-translate-x-3 transition-all h-14">
        <div className="flex gap-5 items-center">
          {/* image card */}
          <div className="card-best-imag rounded-xl ml-3">
            <Link href={`digital-products/product-details/${id}/${title.replaceAll(" ", "-").toLowerCase()}`}>
            <img src={image} alt="test" className="w-14 h-14 " />
            </Link>
          </div>
          {/* title card */}
          <div className="">
