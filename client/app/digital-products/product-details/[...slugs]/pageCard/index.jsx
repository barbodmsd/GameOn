      ...
      <div className="flex pl-11">
        <div className="flex flex-col justify-around">
          ...
          <div className=" -translate-x-16">
            <Tilt>
              <img
                src={"http://localhost:7000/" + images[1]}
                alt=""
                className="w-[700px]"
              />
            </Tilt>
        ...
        <div className="flex flex-col justify-around pr-10">
          <div className="flex flex-col gap-5">
            <div className="w-40 h-40 rounded-xl bg-white">
              <img src={"http://localhost:7000/" + images[0]} alt="" />
            </div>
            <div className="w-40 h-40 rounded-xl bg-white">
              <img src={"http://localhost:7000/" + images[2]} alt="" />
            </div>
            <div className="w-40 h-40 rounded-xl bg-white">
              <img src={"http://localhost:7000/" + images[3]} alt="" />
            </div>
          </div>
          <div className=" flex flex-col gap-5">
