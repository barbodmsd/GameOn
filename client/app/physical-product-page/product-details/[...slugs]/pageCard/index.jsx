      ...
      {images ? (
        <div className='text-black my-10'>
            ...
            <div className='flex flex-col justify-around   '>
              ...
              <div className='flex gap-5 justify-end text-sm'>
                ...
                <button
                  ...
                  className={
                    activBtn == "description"
                      ? "btn-focus"
                      : "btn-notFocus text-sm"
                  }>
                  Description
                </button>
              </div>
              ...
              <div className='flex items-center gap-20'>
                <span className='text-my-yellow font-bold text-lg'>
                  ${price}{" "}
                </span>
                <button
                  onClick={addToCart}
          ...
          {open && (
            <div
              onClick={handleClose}
              className='bg-black/30 w-[900px] h-[400px] absolute rounded-3xl left-[30%] top-[25%] text-white p-10 backdrop-blur-3xl'>
